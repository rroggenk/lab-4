...
# Data for Cards 
vaccine_plot_data_card <- read.csv(file.path(data_dir, "vaccine_plot_data_card.csv"))

# Data for Plot 1 (also used for dynamic card)
vaccine_data <- read.csv(file.path(data_dir, "vaccine_data.csv"))

# Data for Plot 2
vaccine_plot_data <- read.csv(file.path(data_dir, "vaccine_plot_data.csv"))

# Data for Interactive Table
health_data <- read.csv(file.path(data_dir, "health_data.csv"))
